...
class Book extends HTMLElement {
    ...
    // The event "connectedCallback" runs ea time the elem is added to the DOM.
    connectedCallback() {
        // get a handle on all the attributes
...
// Define the custom native web component. & Add the definition to browser.
